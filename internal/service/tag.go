...
func (s *Service) GetTagList(param *TagListRequest, paper *app.Pager) ([]*model.Tag, error) {
	return s.dao.GetTagList(param.Name, param.State, paper.Page, paper.PageSize)
}
